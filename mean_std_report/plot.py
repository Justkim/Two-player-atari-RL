...
print("old_diff", diff)
print("//////////////////////")
non_transfer_area = trapz(merged_data['rolling_mean'])
print("non transfer area =", non_transfer_area)
transfer_area = trapz(merged_data_t['rolling_mean'])
print("transfer area =", transfer_area)
print("area change whole",((transfer_area - non_transfer_area) / abs(non_transfer_area)) * 100)
#print("percentage diff",(transfer_avg - no_transfer_avg) / (abs(transfer_avg + no_transfer_avg) / 2))
print("##########################################")
print("area change last 100 episodes")
non_transfer_area = trapz(merged_data['rolling_mean'][-100:])
print("non transfer area =", non_transfer_area)
transfer_area = trapz(merged_data_t['rolling_mean'][-100:])
print("transfer area =", transfer_area)
print("area change last 100",((transfer_area - non_transfer_area) / abs(non_transfer_area))* 100)
print("///////////////////////////////////////////////////")
...
transfer_norm = ((merged_data_t['rolling_mean'][-100:] - min_val) /(max_val - min_val)).mean() 
